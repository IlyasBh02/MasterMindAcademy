...
if(isset($_SESSION['userId']) && $_SESSION['role'] == 'Enseignant'){
    ...
    <div class="container px-4 sm:px-6 2xl:px-0 flex items-center justify-center min-h-screen relative z-10">
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form method="POST">
                ...
                <p class="text-center mt-6 text-gray-500">Don't have an account? <a href="../user/register.php" class="text-primary-500 font-semibold">Sign up</a></p>
            </form>
        </div>
    </div>
