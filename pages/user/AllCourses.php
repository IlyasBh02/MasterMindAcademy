        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <?php if(!isset($_SESSION['userId'])):?>
                    <button onclick="window.location.href='./login.php'" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm font-medium">
                    login
                </button>
                <?php endif;?>
            </div>
